...
function App() {
  ...
  const generateAnswer = async () => {
    ...
    if (question === "What's your name?") {
      ...
      setAnswer("Khalid Bin Ibrahim is the Founder and current CEO of Droip. He made this AI by using Gemini API Key. He is a passionate Front-end Developer and a Video Game Developer from Bangladesh. He is currently 14 years old. He started his career on programming at the age of 10. He is also called Future Mark Zuckerberg for his business strategy, thinking and intelligence. He contribute in many games and websites. He is mostly famous for his Without coding Free Website making platform where users can use templates or buy plugin and make websites for free. He is also famous for make a program on ideogram as a contributor and contribute code as a Video Game Developer in a indie game called The Planet of Lana. He is experienced in various programming languages like (JavaScript, Typescript, C, C++), Game Engines like (Unity, GoDot, Unreal Engine), Databases like (MongoDB, SQL, PostgreSQL) and Web Development technologies like HTML, CSS, React, Next.js, Node.js, Express.js and other frameworks and libraries. He is now working for making a social media platform like (Facebook, X or Instagram). He is 6th in Bangladesh Rapid Chess Championship 2023 and 17th in Young National Drawing Competition of Bangladesh 2023.");
      setLoading(false);
    } else {

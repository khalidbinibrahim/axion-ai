...
function App() {
  ...
  const generateAnswer = async () => {
    ...
    if (question === "What's your name?") {
      ...
      setAnswer("Humyra Jannat is Khalid Bin Ibrahim's friend. She is from Jamalpur. They know each other in online. They never met face to face. I don't have more information about Humyra Jannat but But they are in the same class and they are the same age now.");
      setLoading(false);
    } else {
